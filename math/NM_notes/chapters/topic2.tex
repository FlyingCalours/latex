...
%For a dense $n\times n$ matrix, the elimination stage requires about
%$\tfrac23 n^3$ arithmetic operations, whereas backward substitution requires only about $n^2$.  This difference becomes important when the same coefficient matrix is used with many right-hand sides.
...
\begin{array}[l|cc]
    ...
    \text{Elimination Steps}& \frac{2n^3+3^2-5n}{6} &\frac{n^3-n}{3} \\
\end{array}
\]

\begin{example}
Use Gaussian Elimination followed by backwards substitution to find the inverse of
\[
 A=\begin{bmatrix}
 1&2&-1\\
 2&1&0\\
...
Reducing $[A\mid I]$ gives
\[
 A^{-1}=\begin{pmatrix}
 -\frac29&\frac59&-\frac19\\[2mm]
 \frac49&-\frac19&\frac29\\[2mm]
 -\frac13&\frac13&\frac13
 \end{pmatrix}.
\]
A direct check confirms that $AA^{-1}=I$.
\end{solution}
